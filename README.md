...
Investor Toolkit is a local-first command-line toolkit for deterministic investor workflows. The CLI ingests public-company research data, calculates metrics and explicit-assumption valuations, and estimates Israeli Section 102 RSU sale taxes.
